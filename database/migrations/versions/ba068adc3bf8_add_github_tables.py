...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("new_users_total", sa.Integer(), nullable=False),
        sa.Column("left_users_total", sa.Integer(), nullable=False),
        sa.Column("active_users_total", sa.Integer(), nullable=False),
        sa.Column("timestamp", sa.DateTime(), nullable=False),
        sa.PrimaryKeyConstraint("id"),
    )
