...
DAG_DIRS = os.path.join(
    os.path.dirname(__file__), os.pardir, "dags"
)
...
@pytest.mark.parametrize(
    "py_file",
    all_py_files,
    ids=[os.path.relpath(f, os.path.join(os.path.dirname(__file__), os.pardir)) for f in all_py_files],
)
