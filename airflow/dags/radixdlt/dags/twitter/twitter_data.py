...
def get_twitter_followers(user_name, consumer_key, consumer_secret, access_token, access_token_secret):
...
def repo_task(user_name, consumer_key, consumer_secret, access_token, access_token_secret):
    return PythonOperator(
        task_id=f"fetch_twitter_user_{user_name}",
        python_callable=lambda: get_twitter_followers(user_name,consumer_key, consumer_secret, access_token, access_token_secret),
        dag=dag,
    )


twitter_user_task1 = repo_task("radixdlt", 
...
twitter_user_task2 = repo_task("scrypto_lang", 
